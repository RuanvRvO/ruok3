  ...
  return (
    <>
      ...
      <main className="p-8 flex flex-col gap-8">
        {activeView === "view1" ? <Content /> : <View2Content />}
      </main>
    </>
  );
}
...
function View2Content() {
  ...
  return (
    <div className="flex flex-col gap-4 max-w-lg mx-auto">
      <div>
        <h2 className="font-bold text-xl text-slate-800 dark:text-slate-200">
          View 2 - {viewer ?? "Anonymous"}
        </h2>
        <p className="text-slate-600 dark:text-slate-400 mt-2">
          This is the second view. You can customize this content however you like!
        </p>
      </div>
    </div>
  );
